					...
					{selectedAnnonce ? (
						<div className="flex flex-1 flex-col h-full overflow-y-auto items-center justify-center">
							<div className="flex w-full max-w-xl flex-col items-center  bg-white lg:p-6 xl:p-8 md:p-2 text-left">
								<h2 className="mb-2 text-base font-bold">Auteur</h2>
								<div className="flex flex-col w-full items-center gap-6 ">
									<Avatar className="hidden h-24 w-24   sm:flex">
										<AvatarImage
											src={`${selectedAnnonce.client?.img_url}`}
									...
									<div className="grid gap-1">
										<p className="text-lg font-bold leading-none text-red-700">
											{selectedAnnonce.client?.prenom}{" "}
											{selectedAnnonce.client?.nom}
										</p>
									</div>
                  ...
                  {selectedAnnonce.id}
								...
								<div className="pt-4 px-0 xl:px-2 w-full flex items-center justify-center flex-col">
									...
									<div className="text-sm grid grid-cols-2 whitespace-nowrap gap-auto items-center justify-start font-bold  w-full mt-4">
										...
										<div className="flex items-end w-full justify-end">
											{format(
												new Date(selectedAnnonce.created_at),
												"dd MMMM yyyy",
												{ locale: fr }
											)}
											{` à ${format(
									...
									<div className="text-sm grid grid-cols-2 whitespace-nowrap gap-auto items-center justify-start font-bold  w-full mt-4">
										...
										<div className="flex items-end w-full justify-end">
											{format(
												new Date(selectedAnnonce.date_depart),
												"dd MMMM yyyy",
												{ locale: fr }
											)}
											{` à ${format(
									...
									<div className="text-sm grid grid-cols-2 whitespace-nowrap gap-auto items-center justify-start font-bold  w-full mt-4">
										...
										<div className="flex items-end w-full justify-end">
											{format(
												new Date(selectedAnnonce.date_arrive),
												"dd MMMM yyyy",
												{ locale: fr }
											)}
											{` à ${format(
								...
								<div className="ml-auto pt-10 w-full items-center justify-center gap-4 flex font-medium">
									<div className="ml-auto pt-14 w-full items-center justify-center flex font-medium">
										<Button
											onClick={() =>
												handleNavigation(selectedAnnonce.id_annonce)
											}
