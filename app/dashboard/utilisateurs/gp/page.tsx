			...
			<Drawer anchor="right" open={isDrawerOpen} onClose={closeDrawer}>
				<div className="p-4 w-[35vw]">
					{isAddingGp ? (
						...
						<div className="flex w-full max-w-xl flex-col items-center border bg-white xl:p-10 p-5 text-left">
							<h2 className="mb-3 text-xl font-bold">Ajouter un Nouveau GP</h2>
						...
						selectedUser && (
							<div className="flex w-full max-w-xl flex-col items-center border bg-white xl:p-10 p-2 text-left">
								<h2 className="xl:mb-8 py-4 text-2xl font-bold">
									{" "}
									GP {selectedUser.prenom} {selectedUser.nom}
								</h2>
								<img
									...
									width={120}
									height={120}
									className="mb-10 xl:h-52 xl:w-52 h-36 w-36 rounded-full object-cover"
								/>
								...
								<div className="text-sm grid grid-cols-2 font-bold p-4 rounded-md shadow-sm w-full  gap-full">
									<div className="font-normal text-sm">Pays</div>
									{selectedUser.Pays}
								</div>
								<div className="text-sm grid grid-cols-2 font-bold p-4 rounded-md shadow-sm w-full  gap-full">
									<div className="font-normal text-sm">Ville</div>
									{selectedUser.ville || "-"}
								</div>
								<div className="text-sm grid grid-cols-2 font-bold p-4 rounded-md shadow-sm w-full  gap-full">
								...
								<div className="text-sm grid grid-cols-2 font-bold p-4 rounded-md shadow-sm w-full  gap-full">
									<div className="font-normal text-sm">Annonces</div>
									{selectedUser.total_annonces}
								</div>
								<div className="text-sm grid grid-cols-2 font-bold p-4 rounded-md shadow-sm w-full  gap-full">
								...
								{/*   <div className="text-sm grid grid-cols-2 p-3 items-center rounded-md shadow-sm w-full gap-full">
                          <div className="font-normal text-sm">Actif</div>
