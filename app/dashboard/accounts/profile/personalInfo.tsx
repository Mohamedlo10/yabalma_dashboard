        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-12">
            ...
            <div className="p-4">
              ...
              {client.email?(<div className="mb-4">
                <div className="text-gray-500 text-sm sm:text-base">Email</div>
                <div className="leading-6 mt-1 text-sm sm:text-base font-bold">{client?.email}</div>
              </div>):( <div className="mb-4">
                <div className="text-gray-500 text-sm sm:text-base">phone</div>
                <div className="leading-6 mt-1 text-sm sm:text-base font-bold">{client?.phone}</div>
              </div>)}
