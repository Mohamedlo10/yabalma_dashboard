...
export default function Page() {
  ...
  return (
    <>
      ...
      <Drawer anchor='right' className="" open={isDrawerOpen} onClose={closeDrawer}>
        <div className="p-4  w-[32vw] items-center h-full justify-center flex">
          {isAddingClient ? (
              ...
              <form className="w-full" onSubmit={handleSubmit}>
                ...
                <div className="space-y-2">
                    ...
                    {roles.map((role, index) => (
                     ...
                     />
                     <label htmlFor={`radio-${role}`} className="text-sm font-medium">
                       {role.nom}
                     </label>
                   </div>
                    ))}
                ...
                <div className="ml-auto pt-8 w-full items-center justify-center flex font-medium">
                  <Button type="submit"  className="w-fit h-10 font-bold">Ajouter le Compte</Button>
                </div>
              </form>
              <ToastContainer />
            </div>
            ...
            selectedUser && (
              <div className="flex w-full max-w-xl flex-col items-center border bg-white p-10 text-left">
                ...
                <Button onClick={() => handleNavigation(selectedUser.id)} className="w-fit h-10 font-bold">Voir Détails</Button>   </div>
