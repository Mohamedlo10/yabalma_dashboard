...
export function CommandeList({ items }: commandeListProps) {
  ...
  return (
    <div className="flex w-fit h-full min-h-0">
      ...
      <div className="w-full md:w-[45%] lg:w-[40%] xl:w-[35%] border-r h-full min-h-0 flex flex-col">
      ...
      <div className="hidden md:flex w-[55%] lg:w-[60%] xl:w-[65%] h-full max-h-[70vh] sm:max-h-[75vh] lg:max-h-[80vh] xl:max-h-[85vh] overflow-y-auto min-h-0 flex-col">
