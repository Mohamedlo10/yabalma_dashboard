...
export const annonceSchema = z.object({
  ...
  type_transport: z.enum(["economy", "express"], {
    required_error: "Le type de transport est requis",
  }),
  created_at: z.string().optional(),
  poids_max: z.number().positive("Le poids maximum doit être positif").nullable(),
  ...
  lieu_depot: z.string().min(1, "Le lieu de dépôt est requis"),
  ...
  shipping_started_at: z.string().optional(),
});
