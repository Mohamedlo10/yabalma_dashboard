            ...
            {editMode && user ? (
              ...
              <div className="mb-6">
                <div className="grid grid-cols-2 gap-36 rounded-lg">
                  ...
                  <div className="p-4">
                    <div className="mb-4">
                      <div className="text-gray-500 text-[11px] sm:text-base">
                        Prenom
                      </div>
                      <div className="leading-6 mt-1 text-[11px] sm:text-base font-bold">
                        {compte?.user_metadata?.prenom}
                      </div>
                    </div>
                    <div className="mb-4">
                      <div className="text-gray-500 text-[11px] sm:text-base">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="leading-6 mt-1 text-[11px] sm:text-base font-bold">
                        {compte?.user_metadata?.poste?.nom}
                      </div>
                    </div>
                  </div>
                  {/* <!-- Second Bloc --> */}
